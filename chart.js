/**
 * TTN — панель графіка (TradingView Advanced Chart Widget)
 * Відкривається під стрічкою тікерів або по кліку на тег у статті.
 */
const TTNChart = (() => {
    ...
    panel.innerHTML = `
      <div class="chart-panel-inner">
        <div class="chart-panel-head">
          ...
          <button id="chart-panel-close" aria-label="Закрити графік">×</button>
        </div>
